...
puts "Set Document with Observe, Returns when Persisted..."
puts
...
puts "Set Document with Observe Asynchronously, Returns when Persisted, and output return values"
puts
...
puts "--------------------------------------------------------------------------"
puts "Couchbase Straight Observe"
